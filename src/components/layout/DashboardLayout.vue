      ...
      <nav class="mt-8">
          ...
          <ul class="space-y-1">
            <li>
              <a href="#" class="bg-blue-50 text-blue-700 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                <svg class="text-blue-500 mr-3 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="px-4 mt-8">
          ...
          <ul class="space-y-1">
            ...
            <li>
              <a href="#" class="text-red-600 hover:bg-red-50 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                <svg class="text-red-500 mr-3 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="flex items-center justify-between h-16 px-8">
          <div class="flex items-center space-x-4">
            ...
            <input 
              type="text" 
              placeholder="Search..." 
              class="border-0 bg-transparent text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0"
            >
          </div>
